document.addEventListener('DOMContentLoaded', function() {
  ...
  // Handle Copy & Shop buttons
  document.querySelectorAll('.copy-shop-btn').forEach(button => {
  ...
  document.getElementById('couponShopLink').addEventListener('click', function(e) {
    e.preventDefault();
    clearTimeout(redirectTimeout);
